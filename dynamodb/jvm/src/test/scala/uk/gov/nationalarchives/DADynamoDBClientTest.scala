...
//
//  val primaryKeysTable: TableFor2[List[Pk], String] = Table(
...
//    )
//
//  val writeAndDeleteItemsTable: TableFor2[List[MockResponse], String] = Table(
...
//  val queryTable: TableFor2[RequestCondition, String] = Table(
//    ("query", "expectedQuery"),
